(function ($) {
  ...
  function track(client) {
    ...
    if (client !== null && client.lat !== null) {
      ...
      $('#last-mac').text(client.manufacturer + " " + lastMac + osStr + " last seen on " + client.seenString +
